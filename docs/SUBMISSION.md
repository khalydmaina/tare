...
- Results: [docs/RESULTS.md, published alongside the demo]
...
> My AI trader says it's 90% sure. Its own record says [X%]. So I built tare: a non-LLM referee that weighs every trade against the model's track record, cross-checks prices, and blocks news-steered trades. Live paper log + attack lab: https://tare-rust.vercel.app #BitgetHackathon @Bitget_AI
